...
def tesco(query):
    with sync_playwright() as p:
        ...
        product_boxes = page.query_selector_all('//*[@id="product-list"]/div[2]/div[4]/div/div/div[2]/div/ul/li')
        
        products = []
        for product_box in product_boxes:
            title = product_box.query_selector("//*/div[2]/h3/a")
            price = product_box.query_selector("//*/div/div/div/div/div/form/div/div/div[1]/p[1]")
            ...
            image_src = image.get_attribute("srcset").split(' ')[0] if image else "No image"
